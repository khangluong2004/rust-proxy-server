...
curl -X POST http://unimelb-comp30023-2025.cloud.edu.au/echo4 --data 'MAX-AGE=1'
curl -s --proxy http://localhost:8080 http://unimelb-comp30023-2025.cloud.edu.au/echo4 -H "X-COMP30023: HI" -o curl.txt
echo "Check 1"
...
# Stale, cache new
curl -X POST http://unimelb-comp30023-2025.cloud.edu.au/echo4 --data ''
curl -s --proxy http://localhost:8080 http://unimelb-comp30023-2025.cloud.edu.au/echo4 -H "X-COMP30023: HI" -o curl.txt
echo "Check 2"
